...
Output: Resume data is sanitized at write time with an allowed HTML subset and max length caps. Password hashing uses Workers-native PBKDF2 with transparent bcryptjs backward compatibility for existing users.
</objective>
